                ...
                <div className="flex flex-wrap gap-2 items-center">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-9 pr-4 py-2 border border-gray-300 rounded-full text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                    </div>
                    <button
                        onClick={onRefresh}
